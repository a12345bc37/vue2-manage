...
if (!window.Quill) {
  window.Quill = __webpack_require__(239);
}
exports.default = {
  name: 'quill-editor',
  data: function data() {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(188)("55dee095", content, true);
...
var quill = __webpack_require__(239)
var quillEditor = __webpack_require__(272)
...
var _vueQuillEditor = __webpack_require__(274);
...
exports.default = {
    ...
    methods: {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.prev = 0;
                                _context.next = 3;
                                return (0, _getData.getTopicCount)();
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 4:
                                ...
                                menu.data.data.forEach(function (item, index) {
                ...
                return _regenerator2.default.wrap(function _callee3$(_context3) {
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                _context3.next = 2;
                                return (0, _getData.getTopic)({ page: this.offset, size: this.limit, restaurant_id: this.restaurant_id });
        ...
        addspecs: function addspecs() {
            this.specs.push((0, _extends3.default)({}, this.specsForm));
        ...
        expand: function expand(row, status) {
            if (status) {
                ...
                var index = this.expendRow.indexOf(row.index);
        ...
        getSelectItemData: function () {
            var _ref4 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(row, type) {
                var _this3 = this;
                ...
                return _regenerator2.default.wrap(function _callee4$(_context4) {
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                _context4.next = 2;
                                return (0, _getData.topicInfo)({ id: row.item_id });

                            case 2:
                                restaurant = _context4.sent;
                                _context4.next = 5;
                                return (0, _getData.topicCategoryInfo)({ id: row.category_id });

                            case 5:
                                category = _context4.sent;

                                this.selectTable = (0, _extends3.default)({}, row, { title: restaurant.data.title, subtitle: restaurant.data.subtitle,
                                    content: restaurant.data.content, category_name: category.data.title, item_pic_url: restaurant.data.item_pic_url });

                                this.selectMenu = { label: category.name, value: row.category_id };
                                this.tableData.splice(row.index, 1, (0, _extends3.default)({}, this.selectTable));

                                this.$nextTick(function () {
                                    _this3.expendRow.push(row.index);
                                });
                                if (type == 'edit') {
                                    this.getMenu();
                                }
            ...
            function getSelectItemData(_x, _x2) {
                return _ref4.apply(this, arguments);
            }

            return getSelectItemData;
        }(),
        ...
        handleDelete: function () {
            var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5(index, row) {
                var res;
                    ...
                    while (1) {
                        switch (_context5.prev = _context5.next) {
                            case 0:
                                _context5.prev = 0;
                                _context5.next = 3;
                                return (0, _getData.deletetTopic)({ id: row.item_id });
                    ...
                    while (1) {
                        switch (_context6.prev = _context6.next) {
                            case 0:
                                ...
                                debugger;
                                _context6.next = 6;
                                return (0, _getData.addFood)(postData);
                            ...
                            case 10:
                                ...
                                console.log('更新信息失败', _context6.t0);
...
// module
exports.push([module.i, ".allcover{position:absolute;top:0;right:0}.ctt{left:50%;transform:translate(-50%,-50%)}.ctt,.tb{position:absolute;top:50%}.tb{transform:translateY(-50%)}.lr{position:absolute;left:50%;transform:translateX(-50%)}.el-dialog--small{width:80%}.demo-table-expand{font-size:0}.demo-table-expand label{width:90px;color:#99a9bf}.demo-table-expand .el-form-item{margin-right:0;margin-bottom:0;width:50%}.table_container{padding:20px}.Pagination{display:-ms-flexbox;display:flex;-ms-flex-pack:start;justify-content:flex-start;margin-top:8px}.avatar-uploader .el-upload{border:1px dashed #d9d9d9;border-radius:6px;cursor:pointer;position:relative;overflow:hidden}.avatar-uploader .el-upload:hover{border-color:#20a0ff}.avatar-uploader-icon{font-size:28px;color:#8c939d;width:120px;height:120px;line-height:120px;text-align:center}.avatar{width:120px;height:120px;display:block}.ql-container .ql-snow{height:240px}.cell{text-align:center}.edit_container{padding:40px;margin-bottom:40px}.editer{height:280px}", ""]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(188)("15a642ae", content, true);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function(props) {
        ...
        }, [_c('span', [_vm._v(_vm._s(props.row.content))])])], 1)]
      }
    }])
    ...
    model: {
      value: (_vm.selectTable.title),
      callback: function($$v) {
        _vm.$set(_vm.selectTable, "title", $$v)
      },
      expression: "selectTable.title"
    }
    ...
    model: {
      value: (_vm.selectTable.subtitle),
      callback: function($$v) {
        _vm.$set(_vm.selectTable, "subtitle", $$v)
      },
      expression: "selectTable.subtitle"
    }
  })], 1), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "分类",
  ...
  }, [(_vm.selectTable.item_pic_url) ? _c('img', {
    staticClass: "avatar",
    attrs: {
      "src": _vm.selectTable.item_pic_url
    }
  }) : _c('i', {
    ...
    model: {
      value: (_vm.selectTable.content),
      callback: function($$v) {
        _vm.$set(_vm.selectTable, "content", $$v)
      },
      expression: "selectTable.content"
    }
  })], 1)], 1), _vm._v(" "), _c('div', {
