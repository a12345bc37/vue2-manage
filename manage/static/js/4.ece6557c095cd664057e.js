    ...
    methods: {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 3:
                                ...
                                if (result.errno == 0) {
                                    result.data.data.map(function (item, index) {
                                        item.value = item.id;
        ...
        submitcategoryForm: function submitcategoryForm(categoryForm) {
            ...
            this.$refs[categoryForm].validate(function () {
                var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(valid) {
                    var params, result;
                        ...
                        while (1) {
                            switch (_context2.prev = _context2.next) {
                                case 0:
                                    ...
                                    _context2.prev = 2;
                                    _context2.next = 5;
                                    return (0, _getData.addCategory)(params);
        ...
        addspecs: function addspecs() {
            this.foodForm.specs.push((0, _extends3.default)({}, this.specsForm));
                        ...
                        while (1) {
                            switch (_context3.prev = _context3.next) {
                                case 0:
                                    ...
                                    params = (0, _extends3.default)({}, _this2.foodForm, {
                                        topic_category_id: _this2.selectValue.id
                                    });
                                    _context3.prev = 2;
                                    _context3.next = 5;
                                    return (0, _getData.addFood)(params);
                                ...
                                case 5:
                                    ...
                                    if (result.errno == 0) {
                                        ...
                                        _this2.$router.push({ path: 'foodlist' });
                                    } else {
                                        _this2.$message({
                                            type: "error",
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(188)("5d9e3300", content, true);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('head-top'), _vm._v(" "), _c('el-row', {
    ...
    model: {
      value: (_vm.foodForm.title),
      callback: function($$v) {
        _vm.$set(_vm.foodForm, "title", $$v)
      },
      expression: "foodForm.title"
    }
    ...
    model: {
      value: (_vm.foodForm.subtitle),
      callback: function($$v) {
        _vm.$set(_vm.foodForm, "subtitle", $$v)
      },
      expression: "foodForm.subtitle"
    }
  })], 1), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "上传LOGO图片"
  ...
  }, [(_vm.foodForm.item_pic_url) ? _c('img', {
    staticClass: "avatar",
    attrs: {
      "src": _vm.foodForm.item_pic_url
    }
  }) : _c('i', {
    ...
    model: {
      value: (_vm.foodForm.content),
      callback: function($$v) {
        _vm.$set(_vm.foodForm, "content", $$v)
      },
      expression: "foodForm.content"
    }
  })], 1), _vm._v(" "), _c('el-form-item', {
    staticStyle: {
      "margin-top": "130px"
