...
export const getCategoryList = () => fetch('/topiccategory/category');
export const topicCategoryInfo = data => fetch('/topiccategory/info', data);
export const addTopicCategory = data => fetch('/topiccategory/storeCategory', data, 'POST');

/**
 * 添加文章
 */

export const addFood = data => fetch('/topic/store', data, 'POST');

/**
 * 获取文章列表
 */

export const getTopic = data => fetch('/topic/index', data);
...
export const deletetTopic = data => fetch('/topic/destory', data);

/**
 * 删除文章
 */

export const topicInfo = data => fetch('/topic/info', data);

/**
 * 获取食品数量
 */

export const getTopicCount = () => fetch('/topic/count');
